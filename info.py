...
API_ID = int(environ.get("API_ID", "21711251"))
API_HASH = environ.get("API_HASH", "77bfefd0fe7dfc048c1f85d14c88391c")
BOT_TOKEN = environ.get("BOT_TOKEN", "7632405492:AAEuAAbQNlmC9DtQLskphuRTqFhf4ephDaw")
PORT = environ.get("PORT", "8082")

# Owners
ADMINS = [
    int(admin) if id_pattern.search(admin) else admin
    for admin in environ.get("ADMINS", "6118320345").split()
]
OWNER_USERNAME = environ.get(
    "OWNER_USERNAME", "FHD24x7FeedBot"
)  # without @ or https://t.me/
USERNAME = environ.get("USERNAME", "FHDmovies24x7")  # ADMIN USERNAME

# Database Channel
CHANNELS = [
    int(ch) if id_pattern.search(ch) else ch
    for ch in environ.get("CHANNELS", "-1002721082872").split()
]
...
START_IMG = (
    environ.get(
        "START_IMG",
        " https://graph.org/file/11be37e22287b3d24b7f2.jpg",
    )
).split()
FORCESUB_IMG = environ.get("FORCESUB_IMG", "https://i.ibb.co/ZNC1Hnb/ad3f2c88a8f2.jpg")
REFER_PICS = (environ.get("REFER_PICS", "https://envs.sh/PSI.jpg")).split()
PAYPICS = (
    environ.get("PAYPICS", "https://telegra.ph/HgBotz-07-30")
).split()
